...
import { ActionControl, BulkActionControl, Column, CustomColumnConfig, DataGridComponent, DataSourceModifier, FilteringActionType, FilteringModifier, GridConfig, HeaderActionControl, LoadMoreMode, Pagination, ServerSideDataResult } from '@c8y/ngx-components';
...
export declare class DeviceGridComponent implements OnInit, OnDestroy {
    ...
    columnsConfig: DeviceGridColumn[];
    ...
    columns$: Observable<DeviceGridColumn[]>;
     ...
     */
    private saveGridConfigSemaphore$;
    private destroyed$;
    ...
    updateFilterConfig(columnName: any, filteringModifier: any): void;
    ...
    addCustomColumn(columnConfig: CustomColumnConfig): void;
    removeCustomColumn(columnToRemove: Column): void;
    private getDefalultConfigColumns;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<DeviceGridComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<DeviceGridComponent, "c8y-device-grid", never, { "refresh": "refresh"; "title": "title"; "loadMoreItemsLabel": "loadMoreItemsLabel"; "loadingItemsLabel": "loadingItemsLabel"; "selectable": "selectable"; "baseQuery": "baseQuery"; "childDeviceGrid": "childDeviceGrid"; "withChildren": "withChildren"; "_pagination": "pagination"; "_infiniteScroll": "infiniteScroll"; "_actionControls": "actionControls"; "_bulkActionControls": "bulkActionControls"; "_headerActionControls": "headerActionControls"; "dataCallback": "dataCallback"; "columnsConfigKey": "columnsConfigKey"; "columnsConfig": "columns"; "parentDeviceId": "parentDeviceId"; }, { "onColumnsChange": "onColumnsChange"; "onFilterChange": "onFilterChange"; "onDeviceQueryStringChange": "onDeviceQueryStringChange"; "itemsSelect": "itemsSelect"; }, never, never>;
}
