...
msgstr "接続性設定が設定されていません。管理アプリの <a href=\"{{ link }}\">設定</a> で設定してください。"
...
msgstr "接続プランを LoRa プラットホームから取得できませんでした。管理アプリの <a href=\"{{ link }}\">設定</a> で ThingPark 資格情報を検証します。"
...
# /* locked: requested by customer in MTM-52050 */
msgid "Display the sub assets tab on groups."
...
msgstr "エクスポートされたデータを含むファイルは、{tenant-domain}/apps/cockpit/index.html#?download={binaryId} からダウンロードできます。"
...
msgstr ""
"詳細は、\n"
"        <a c8y-guide-href=\"reference/smartrest-two/\"> Device SDK guide </a> を参照してください。"
...
msgstr ""
"詳細は、\n"
"      <a c8y-guide-href=\"users-guide/cockpit/#reports\"> User guide </a> を参照してください。"
...
msgstr "主な相違は認証情報の保管です。Basic Auth では、セッション保管に保管されます。OAI-Secure では HttpOnly Cookie に保存されます。認証情報は、JavaScript を介してアクセスできないため、OAI-Secure 付与が推奨されます。"
...
msgstr "このアプリケーションのランディング ページです。デフォルトでは、テナント全般のデータを表示する、カスタマイズ可能なダッシュボードです。"
...
"            Sensor App."
msgstr ""
"Cumulocity IoT Sensor App を使用して、IoT プラットフォーム\n"
...
msgstr "またはクリックしてファイル システムを参照します。"
...
"            example:"
msgstr ""
"デバイスの ID を取得し、ユーザーをデバイス詳細ビューにリダイレクトします。\n"
"            (例)"
...
"            example:"
msgstr ""
"グループの ID を取得し、ユーザーをグループ詳細ビューにリダイレクトします。\n"
"            (例)"
