...
msgstr "\"{{name}}\" 使用者使用 OAI-Secure 模式登錄失敗"
...
msgstr "在下面按一下可添加第一個設備協定。"

msgid "Click below to add your first endpoint."
msgstr "按一下下面以添加您的第一個端點。"
...
msgstr "配置類型：Basic Auth。"

msgid "Configuration type: OAI-Secure."
msgstr "配置類型：OAI-Secure。"
...
msgid "Connectivity settings are not configured. Configure them in the Administration app under <a href=\"{{ link }}\">Settings</a>."
msgstr "未配置連接設置。在“管理”應用程式的<a href=\"{{ link }}\">設置</a>下方進行設置。"

msgid "Connectivity settings are not configured. Contact the administrator."
msgstr "未配置連接設置。請聯繫管理員。"
...
msgstr "無法從 LoRa 平臺獲取連接計畫。請聯繫管理員。"

msgid "Could not get connectivity plans from the LoRa platform. Verify the ThingPark credentials in the Administration app under <a href=\"{{ link }}\">Settings</a>."
...
msgstr "ID 為 \"{{deviceId}}\" 的設備註冊請求處於“被阻止”狀態，而不是“正在等待接受”。移除此註冊請求並重新開始。"
...
msgstr "設備 {{ devEUI }} 已在您的租戶或平臺的另一個租戶中註冊。"
...
msgstr "啟用從 UI 更改目前值（例如，使用 Fieldbus 小組件）。"

msgid "Enable owner"
msgstr "啟用所有者"

msgid "Enable showing current value in UI (for example, on the Fieldbus widget)."
msgstr "啟用在 UI 中顯示目前值（例如，在 Fieldbus 小組件上）。"
...
msgstr "輸入您的短信提供商提供的憑據。這將啟用利用短信服務的平臺功能（例如，雙因素身份驗證和用戶通知）。"
...
msgstr ""
"尤其是更改全域角色“設備”可能會導致安全性漏洞，例如，\n"
"如果設備受到威脅，攻擊者可能會擴展對平臺的存取權限。"
...
msgstr "已匯出的資料檔案可以從 {tenant-domain}/apps/cockpit/index.html#?download={binaryId} 下載。"
...
msgid ""
"Find out more in the\n"
"        <a c8y-guide-href=\"reference/smartrest-two/\"> Device SDK guide`KEEP_ORIGINAL` </a>."
msgstr ""
"在\n"
"        <a c8y-guide-href=\"reference/smartrest-two/\"> Device SDK guide</a> 中瞭解更多資訊。"
...
msgstr ""
"在\n"
"        <a c8y-guide-href=\"users-guide/cockpit/#dashboards\"> User guide</a> 中瞭解更多資訊。"
...
msgstr ""
"在\n"
"      <a c8y-guide-href=\"users-guide/cockpit/#reports\"> User guide</a> 中瞭解更多資訊。"
...
msgstr ""
"在\n"
"      <a c8y-guide-href=\"users-guide/device-management/#simulator\"> User guide</a> 中瞭解更多資訊。"
...
"      <a c8y-guide-href=\"device-tutorials/tutorials-introduction/\">Device integration tutorial`KEEP_ORIGINAL`</a>\n"
"      to get more information."
msgstr ""
"在\n"
"      <a c8y-guide-href=\"device-tutorials/tutorials-introduction/\">Device integration tutorial</a>\n"
" 中查找設備類型，以獲取更多資訊。"

msgid ""
"Find your protocol in the\n"
"      <a c8y-guide-href=\"protocol-integration/overview/\">Protocol integration guide`KEEP_ORIGINAL`</a>\n"
"      to get more information."
msgstr ""
"在\n"
...
msgstr "首先，您必須通過按一下“上傳認證”上傳相應的認證。"
...
"        other expression, for example, <var ng-non-bindable>{{ placeholderName }}</var>. Then you can use this placeholderName in bindings handled by Angular. There are also\n"
"        predefined functions available:"
msgstr ""
"要識別預留位置，需要在大括弧中至少使用它一次，\n"
"並且沒有其他運算式，如 <var ng-non-bindable>{{ placeholderName }}</var>。接著您可以在 Angular 處理的綁定中使用這個 placeholderName。\n"
"還有預定義函數可用："
...
msgstr "在 OAI-Secure 內部登錄模式下，權杖的有效期限制由 JWT 權杖確定，不能在此處編輯。"
...
msgid "Main difference is the storage of the authentication information. With Basic Auth, it is saved in a session storage and with OAI-Secure in a HttpOnly cookie. OAI-Secure grant is recommended as the authentication information is not accessible via JavaScript."
msgstr "主要差異是驗證資訊的存儲。使用 Basic Auth，將儲存在會話存儲中，而使用 OAI-Secure 將儲存在 HttpOnly Cookie 中。建議使用 OAI-Secure 授權，因為無法通過 JavaScript 訪問驗證資訊。"
...
msgstr "主要區別在於驗證資訊的存儲。使用 Basic Auth，它儲存在會話存儲中，而使用 OAI-Secure 則儲存在 HttpOnly Cookie 中。建議使用 OAI-Secure 授權，因為無法通過 JavaScript 訪問驗證資訊。單點登錄重定向允許使用者使用 OAuth2 協議通過單個第 3 方授權伺服器登錄。"
...
msgid "Must be a valid product certificate key, for example, P_001F_EDCB_01"
msgstr "必須是有效的產品認證金鑰，例如 P_001F_EDCB_01"

msgid "Must be a valid product certificate key, for example, {{ example }}"
msgstr "必須是有效的產品認證金鑰，例如 {{ example }}"
...
msgid "No LoRa provider settings found. Connectivity settings must be configured."
...
msgstr "未找到連接計畫。必須通過 LoRa 平臺創建新連接計畫。"
...
msgstr "沒有可用插槽的連接計畫。請聯繫 ThingPark，瞭解您的連接計畫的設備配額限制，或從 ThingPark 中移除未使用的設備，然後重新嘗試在 {{companyName}} 平臺中註冊該設備。"

msgid "No contracts found. New contracts must be created via the Sigfox platform."
msgstr "未找到任何合同。新合同必須通過 Sigfox 平臺創建。"
...
msgstr "未找到設備設定檔。通過 LoRa 平臺創建新設備設定檔。"
...
msgstr "未配置設備協定。在<a href=\"{{ link }}\">設備協定</a>中創建 LoRa 設備協定。"
...
msgstr "未配置設備協定。在<a href=\"{{ link }}\">設備協定</a>中創建 Sigfox 設備協定。"
...
msgid "No event processing rules to display."
msgstr "未顯示事件處理規則。"
...
msgstr ""
"{{ expectedDateFrom | absoluteDateTimeFormat:'LL, LTS':'+0000' }} 中沒有日誌可用，\n"
"而是從 {{ actualDateFrom | absoluteDateTimeFormat:'LL, LTS':'+0000' }} 載入了最近的日誌。"
...
msgstr "您授予許可權的物件的片段類型（例如 c8y_IsDevice）。請注意，要訪問物件，用戶必須能夠訪問其所有片段。使用星號 (*) 可以為任何物件的片段類型授予許可權。"
...
msgstr "僅允許使用數字，例如 1528197925677。"
...
msgstr "密碼必須至少有 8 個字元且不超過 32 個字元，並且只能包含字母、數位和以下符號：{{ symbols }}"
...
msgstr "密碼必須至少包含 {{ min }} 個字元且不超過 {{ max }} 個字元，並且只能包含字母、數位和以下符號：{{ symbols }}"
...
msgid "Placeholders: {tenant-domain}, {host}, {token}, {email}. Whole link to reset password can be, for example: {tenant-domain}/apps/devicemanagement/index.html?token={token}&email={email}"
msgstr "預留位置：{tenant-domain}、{host}、{token}、{email}。例如，用於重置密碼的整個連結可以是：{tenant-domain}/apps/devicemanagement/index.html?token={token}&email={email}"

msgid "Placeholders: {tenant-domain}, {host}, {token}. Whole link to setup password can be, for example: {tenant-domain}/apps/devicemanagement/index.html?token={token}"
msgstr "預留位置：{tenant-domain}、{host}、{token}。例如，用於設置密碼的整個連結可以是：{tenant-domain}/apps/devicemanagement/index.html?token={token}"
...
msgstr "可能的值：\"true\"、\"false\"，或直到用戶應保持活動狀態的特定日期，例如 \"{{ exampleDate }}\"。將其留空會將值設置為 \"true\"。"
...
msgstr "提供的安全權杖與為此設備 \"{{deviceId}}\" 存儲的安全權杖不匹配。"
...
msgstr "註冊單個 Actility 設備"

msgid "Register a single Sigfox device"
msgstr "註冊單個 Sigfox 設備"
...
msgid "Show items registered after"
msgstr "顯示在以下項後註冊的項："

msgid "Show items with IMEI"
msgstr "顯示含以下 IMEI 的項："
...
msgid "Show services updated after"
msgstr "顯示在以下項後更新的服務："
...
msgstr "無法刪除已訂閱或當前的應用程式。刪除父租戶上的應用程式或從當前項中將其取消訂閱。"
...
msgstr "TOTP 需要 OAI-Secure 登錄模式。"
...
msgstr ""
"外部 ID 連結設備資訊和物理世界（例如，序號、IMEI）。\n"
"\n"
"如果由於某種原因需要更換硬體，也必須將外部 ID 替換為適當的資訊。\n"
"\n"
"通過此程式，新硬體仍連結到其前身創建的資訊。"
...
msgid "The landing page for this application. By default it is a customizable dashboard displaying data for the overall tenant."
msgstr "此應用程式的登錄頁面。預設情況下，它是一個可自訂的儀錶板，顯示整個租戶的資料。"
...
msgstr "提供的安全權杖與為設備 \"{{deviceId}}\" 存儲的權杖不匹配。嘗試註冊此設備時，您已達到最大嘗試失敗次數。該請求現在將被阻止，必須手動移除才能重新開機進程。"
...
msgstr "此命令可用於遷移以非標準方式創建的 LWM2M 設備。它可以採用逗號分隔的設備管理物件 ID 作為參數。如果指定了 ID，則僅針對這些設備進行遷移。如果在沒有任何參數的情況下發送命令，則代理將查找可能未以標準方式創建的 LWM2M 設備，並嘗試遷移它們。用法：migrateLwm2mDevices 1122,3344 或 migrateLwm2mDevices"

msgid "This command returns a list of shell commands with description that can be created for the LWM2M device connector."
msgstr "此命令將返回一個 shell 命令清單，其中包含可為 LWM2M 設備連接器創建的說明。"
...
msgstr "僅當用戶上傳包含要從平臺刪除的端點 ID 清單的 CSV 檔案時，代理才會觸發此操作。操作的源是 LWM2M 設備連接器。用戶無法使用 shell 命令觸發此操作。"
...
msgstr "僅當用戶上傳包含註冊新 LWM2M 設備所需所有資訊的 CSV 檔案時，代理才會觸發此操作。操作的源是 LWM2M 設備連接器。用戶無法使用 shell 命令觸發此操作。"
...
msgstr ""
"打開已註冊的設備並等待建立連接。連接設備後，\n"
"其狀態將更改為“正在等待接受”。您需要通過\n"
"按一下“接受”按鈕來批准它。"
...
msgstr "從中請求 OAuth 權杖的 URL（選取 OAuth 方法時需要）"
...
msgstr "更新 SSO 配置將登出所有使用“OAI-Secure”或“單點登錄重定向”登錄的用戶。是否要繼續？"

msgid "Updating global roles will force you to log out. Do you want to proceed?"
msgstr "更新全域角色將強制您註銷。是否要繼續？"

msgid "Updating password or global roles will force user \"{{userName}}\" to log out. Do you want to proceed?"
msgstr "更新密碼或全域角色將強制用戶 \"{{userName}}\" 註銷。是否要繼續？"
...
msgstr "使用設備報告的物件 6 的通用時間戳記資源 5518 和 6050 或物件特定時間戳記（如果可用）"
...
"            Sensor App."
msgstr ""
"使用此嚮導利用 Cumulocity IoT\n"
" Sensor App 將您的智慧手機連接到我們的 IoT 平臺。"
...
msgstr ""
"我們不收集任何個人資料。我們從您的手機中檢索的唯一資料是感測器\n"
"資料和匿名應用程式使用情況資料。"
...
msgstr "您即將刪除報表 \"{{ reportName }}\"。請注意，該報表分配了一個鎖定的儀錶板。是否要繼續？"
...
msgstr "您即將從儀錶板中移除小組件 \"{{ widgetTitle }}\"。是否要繼續？"
...
msgstr "您沒有管理 {{ vm.userId }} 的庫存角色所需的許可權。"
...
"        registered."
msgstr ""
"您已達到 {{ vm.limitStatus.limit }} 台設備的限制。無法\n"
"        再註冊設備。"
...
msgstr "例如：{{ example }}，您可以使用星號 (*) 作為萬用字元"
...
msgid "or click to browse your file system."
msgstr "或按一下以流覽您的檔案系統。"
...
msgstr ""
"獲取警報狀態物件並返回可用於設置樣式的 CSS 類：\n"
"none、warning、minor、major、\n"
"critical，例如："

msgid ""
"takes the device ID and redirects the user to the device details view, for\n"
"            example:"
msgstr ""
"獲取設備 ID 並將用戶重定向至設備詳細資訊檢視，\n"
"例如："

msgid ""
"takes the group ID and redirects the user to the group details view, for\n"
"            example:"
msgstr ""
"獲取群組 ID 並將用戶重定向至群組詳細資訊檢視，\n"
"例如："
...
msgstr "{{ bulkOperationsCountExecuting }} 正在執行"
...
msgstr "{{ failedDevicesCount }} 台設備註冊失敗"
...
msgstr "{{ successfulDevicesCount }} 台設備已註冊"
