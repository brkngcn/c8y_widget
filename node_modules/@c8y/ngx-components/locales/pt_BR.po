...
"            ou clique para procurar em seu sistema de arquivos."
...
msgstr "As configurações de conectividade não estão definidas. Defina-as no aplicativo Administração em <a href=\"{{ link }}\">Configurações</a>."
...
msgstr "Não foi possível obter planos de conectividade da plataforma LoRa. Verifique as credenciais do ThingPark no aplicativo Administração em <a href=\"{{ link }}\">Configurações</a>."
...
msgstr "Exibe um link para a lista de exportações no menu de navegação Configuração."
...
msgstr "Exibir um painel com links de acesso rápido"
...
msgstr "Ocorreram erros durante a execução de regras de processamento de eventos. <br> Verifique os <a href=\"/apps/devicemanagement/#/alarms\">alarmes criados</a> para obter mais detalhes."
...
msgstr ""
"Obtenha mais informações no\n"
"        <a c8y-guide-href=\"reference/smartrest-two/\"> Device SDK guide </a>."
...
msgstr ""
"Encontre seu tipo de dispositivo no\n"
...
"        outra expressão, por exemplo, <var ng-non-bindable>{{ placeholderName }}</var>. Então você pode usar esse placeholderName em ligações tratadas pelo Angular. Também estão disponíveis\n"
...
msgstr "A principal diferença é o armazenamento da informação de autenticação. Com Basic Auth, ele é salvo em uma sessão de armazenamento e com OAI-Secure em um cookie HttpOnly. A concessão OAI-Secure é recomendada, uma vez que a informação de autenticação não é acessível via JavaScript."
...
msgstr "Deve ser uma chave de certificado de produto válida, por exemplo, P_001F_EDCB_01"
...
msgstr "Nenhuma regra de processamento de eventos para exibir."
...
msgstr "Espaços reservados: {tenant-domain}, {host}, {token}, {email}. Link completo para redefinir a senha pode ser, por exemplo: {tenant-domain}/apps/devicemanagement/index.html?token={token}email={email}"
...
msgstr "Espaços reservados: {tenant-domain}, {host}, {token}. Link completo para definir a senha pode ser, por exemplo: {tenant-domain}/apps/devicemanagement/index.html?token={token}"
...
msgstr "Digitalize este código QR com seu smartphone usando a aplicação Google Authenticator."
...
msgstr "Deve ter pelo menos {{ minLength }} caracteres"
...
msgstr "Mostrar itens registrados após"
...
msgstr "Mostrar serviços atualizados após"
...
msgstr "A aplicação padrão especifica a aplicação que aparece por padrão ao fazer login na plataforma. Aplica-se a todos os usuários do tenant. Selecione uma aplicação na lista abaixo e verifique se todos os usuários podem acessar esta aplicação."
...
msgstr "A página de destino para esta aplicação. Por padrão, é um painel personalizável que exibe dados de todos os tenants."
...
msgstr "Esta aplicação não contém plugins."
...
"            Sensor App."
msgstr ""
"Use este assistente para conectar seu smartphone à nossa plataforma IoT usando a aplicação\n"
...
msgstr ""
"Não obtemos dados pessoais. Os únicos dados que obtemos do seu telefone são\n"
"            dados anônimos do sensor e os dados de uso da aplicação."
...
msgstr "Você está prestes a remover os plugins da aplicação \"{{ humanizedAppName }}\". A operação pode levar vários minutos. Durante esse período, a aplicação poderá estar indisponível. Deseja continuar?"
...
msgstr "ou clique para navegar no seu sistema de arquivos."
...
"            example:"
msgstr ""
"obtém o ID do dispositivo e redireciona o usuário para a exibição de detalhes do dispositivo,\n"
"            por exemplo:"
...
"            example:"
msgstr ""
"obtém o ID do grupo e redireciona o usuário para a exibição de detalhes do grupo,\n"
"             por exemplo:"
