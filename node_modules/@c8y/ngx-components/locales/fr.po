...
"            ou cliquez pour parcourir votre système de fichiers."
...
msgstr "Le fichier contenant les données exportées peut être téléchargé depuis {tenant-domain}/apps/cockpit/index.html#?download={binaryId}."
...
msgstr ""
"Recherchez votre type d'appareil dans le\n"
...
msgstr ""
"Pour que les espaces réservés puissent être reconnus, ils doivent être au moins utilisés une fois dans des accolades sans\n"
"        aucune autre expression, par exemple, <var ng-non-bindable>{{ placeholderName }}</var>. Vous pouvez alors utiliser ce nom d'espace réservé dans des liaisons gérées par Angular. Il existe également\n"
...
msgstr "La différence majeure concerne le stockage des informations d'authentification. Avec Basic Auth, elles sont enregistrées dans un stockage de session, alors qu'avec OAI-Secure, elles sont placées dans un cookie HttpOnly. L'accès OAI-Secure est recommandé, car les informations d'authentification ne sont pas accessibles via JavaScript."
...
msgstr "Doit être une clé de certificat de produit valide, par exemple P_001F_EDCB_01"
...
msgstr "Aucun paramètre du fournisseur LoRa trouvé. Les paramètres de connectivité doivent être configurés."
...
msgstr "Aucune règle de traitement d'événement à afficher."
...
msgstr "Espaces réservés : {tenant-domain}, {host}, {token}, {email}. Le lien complet de réinitialisation du mot de passe peut être, par exemple : {tenant-domain}/apps/devicemanagement/index.html?token={token}&email={email}"
...
msgstr "Espaces réservés : {tenant-domain}, {host}, {token}. Le lien complet de réinitialisation du mot de passe peut être, par exemple : {tenant-domain}/apps/devicemanagement/index.html?token={token}"
...
msgstr "Doit avoir au maximum {{ maxLength }} caractères"
...
msgstr "Afficher les éléments enregistrés après"
...
msgstr "Afficher les services mis à jour après"
...
msgstr "Page d'accueil de cette application. Par défaut, il s'agit d'un tableau de bord pouvant être personnalisé affichant les données de l'ensemble du gérant."
...
"            Sensor App."
msgstr ""
"Utilisez cet assistant pour connecter votre smartphone à notre plate-forme IoT grâce à l'application Cumulocity IoT\n"
"            Sensor."
...
"            platform."
msgstr ""
"L'utilisation de votre smartphone comme source de données de capteurs vous permet de commencer à utiliser notre\n"
"            plate-forme IoT rapidement."
...
msgstr ""
"Nous ne recueillons aucune de vos données personnelles. Les seules données que nous extrayons de votre téléphone concernent les\n"
"            capteurs et l'utilisation anonymisée d'applications."
...
msgstr "ou cliquez pour parcourir votre système de fichiers."
...
"            example:"
msgstr ""
"prend l'ID de l'appareil et redirige l'utilisateur vers la vue des détails de l'appareil, par\n"
"            exemple :"
...
"            example:"
msgstr ""
"prend l'ID du groupe et redirige l'utilisateur vers la vue des détails du groupe, par\n"
"            exemple :"
