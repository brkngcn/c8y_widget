...
msgstr "未配置连接设置。在“管理”应用程序的<a href=\"{{ link }}\">设置</a>下方进行设置。"
...
msgstr "已导出的数据文件可以从 {tenant-domain}/apps/cockpit/index.html#?download={binaryId} 下载。"
...
msgstr ""
"在\n"
"        <a c8y-guide-href=\"reference/smartrest-two/\"> Device SDK guide</a> 中了解更多信息。"
...
msgstr ""
"在\n"
"        <a c8y-guide-href=\"users-guide/cockpit/#dashboards\"> User guide</a> 中了解更多信息。"
...
msgstr ""
"在\n"
"      <a c8y-guide-href=\"users-guide/cockpit/#reports\"> User guide</a> 中了解更多信息。"
...
msgstr ""
"在\n"
"      <a c8y-guide-href=\"users-guide/device-management/#simulator\"> User guide</a> 中了解更多信息。"
...
"并且没有其他表达式，如 <var ng-non-bindable>{{ placeholderName }}</var>。接着您可以在 Angular 处理的绑定中使用这个 placeholderName。\n"
"还有预定义函数可用："
...
msgstr "主要差异是验证信息的存储。使用 Basic Auth，将保存在会话存储中，而使用 OAI-Secure 将保存在 HttpOnly Cookie 中。建议使用 OAI-Secure 授权，因为无法通过 JavaScript 访问验证信息。"
...
msgstr "占位符：{tenant-domain}、{host}、{token}、{email}。例如，用于重置密码的整个链接可以是：{tenant-domain}/apps/devicemanagement/index.html?token={token}&email={email}"
...
msgstr "占位符：{tenant-domain}、{host}、{token}。例如，用于设置密码的整个链接可以是：{tenant-domain}/apps/devicemanagement/index.html?token={token}"
...
msgstr "应有至少 {{ minLength }} 个字符"

msgid "Should have at most {{ maxLength }} characters"
msgstr "至多只能有 {{ maxLength }} 个字符"
...
msgstr "此应用程序的登录页面。默认情况下，它是一个可自定义的仪表板，显示整个租户的数据。"
...
"            Sensor App 将您的智能手机连接到我们的 IoT 平台。"
...
msgstr ""
"我们不收集任何个人数据。我们从您的手机中检索的唯一数据是传感器\n"
"数据和匿名应用程序使用情况数据。"
...
"          registered."
msgstr ""
"您已达到 {{ vm.limitStatus.limit }} 个设备的限制。无法再注册\n"
"设备。"
