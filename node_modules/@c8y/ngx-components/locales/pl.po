...
"            lub kliknij, aby przejrzeć swój system plików."
...
msgstr ""
"Znajdź typ urządzenia w podręczniku\n"
...
"      to get more information."
msgstr ""
"Znajdź swój protokół w podręczniku\n"
...
"        żadnego innego wyrażenia, na przykład: <var ng-non-bindable>{{ placeholderName }}</var>. Później można używać tego symbolu zastępczego w powiązaniach obsługiwanych przez Angular. Dostępne są także\n"
...
msgstr "Podstawowa różnica polega na przechowywaniu informacji uwierzytelniających. W uwierzytelnianiu podstawowym są one zapisane w pamięci sesji, a w uwierzytelnianiu OAI-Secure w pliku cookie HttpOnly. Uwierzytelnianie OAI-Secure jest zalecane, ponieważ informacje uwierzytelniające nie są dostępne za pośrednictwem języka JavaScript."
...
msgstr "Musi to być prawidłowy klucz certyfikatu produktu, na przykład: P_001F_EDCB_01"
...
msgstr "Brak reguł przetwarzania zdarzeń do wyświetlenia."
...
msgstr "Symbole zastępcze: {tenant-domain}, {host}, {token}, {email}. Całe łącze do zresetowania hasła może wyglądać na przykład następująco {tenant-domain}/apps/devicemanagement/index.html?token={token}&email={email}"
...
msgstr "Symbole zastępcze: {tenant-domain}, {host}, {token}. Pełne łącze do konfigurowania hasła to na przykład: {tenant-domain}/apps/devicemanagement/index.html?token={token}"
...
msgstr "Pokaż elementy zarejestrowane po"
...
msgstr "Pokaż usługi zaktualizowane po"
...
msgstr "Strona docelowa tej aplikacji. Domyślnie jest to modyfikowalny pulpit wyświetlający dane dotyczące całego tenanta."
...
msgstr "lub kliknij, aby przejrzeć system plików."
...
"            example:"
msgstr ""
"pobiera identyfikator urządzenia i przekierowuje użytkownika do widoku\n"
"            szczegółów urządzenia, na przykład:"

msgid ""
"takes the group ID and redirects the user to the group details view, for\n"
"            example:"
msgstr ""
"pobiera identyfikator grupy i przekierowuje użytkownika do widoku\n"
"            szczegółów grupy, na przykład:"
