(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@c8y/ngx-components/auth-configuration', ['exports', '@angular/core', '@c8y/ngx-components', '@c8y/client', 'lodash-es', '@angular/forms', '@angular/router', 'rxjs', 'rxjs/operators', '@c8y/client', 'ngx-bootstrap/popover', '@ngx-translate/core'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.c8y = global.c8y || {}, global.c8y["ngx-components"] = global.c8y["ngx-components"] || {}, global.c8y["ngx-components"]["auth-configuration"] = {}), global.ng.core, global.c8y["ngx-components"], global.client, global.lodashEs, global.ng.forms, global.ng.router, global.rxjs, global.rxjs.operators, global.i1, global.popover, global.core));
})(this, (function (exports, i0, ngxComponents, client, lodashEs, forms, router, rxjs, operators, i1, popover, core) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    SsoConfigurationGuard.decorators = [
        { type: i0.Injectable }
    ];
