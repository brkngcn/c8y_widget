(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@c8y/client'),require('@c8y/ngx-components'),require('@angular/common'),require('@ngx-translate/core'),require('@angular/forms'),require('ngx-bootstrap/popover'),exports, require('@angular/core'), require('@c8y/client'), require('@c8y/ngx-components'), require('lodash-es'), require('rxjs'), require('rxjs/operators'), require('file-saver'), require('@ngx-translate/core'), require('@angular/forms'), require('@angular/common'), require('ngx-bootstrap/popover')) :
    typeof define === 'function' && define.amd ? define('@c8y/ngx-components/repository/shared', ['@angular/core','@c8y/client','@c8y/ngx-components','@angular/common','@ngx-translate/core','@angular/forms','ngx-bootstrap/popover','exports', '@angular/core', '@c8y/client', '@c8y/ngx-components', 'lodash-es', 'rxjs', 'rxjs/operators', 'file-saver', '@ngx-translate/core', '@angular/forms', '@angular/common', 'ngx-bootstrap/popover'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.c8y.client,global.c8y.ngxComponents,global.ng.common,global.ngxTranslate.core,global.ng.forms,global.ngxBootstrap.popover,(global.c8y = global.c8y || {}, global.c8y["ngx-components"] = global.c8y["ngx-components"] || {}, global.c8y["ngx-components"].repository = global.c8y["ngx-components"].repository || {}, global.c8y["ngx-components"].repository.shared = {}), global.ng.core, global.client, global.c8y["ngx-components"], global.lodashEs, global.rxjs, global.rxjs.operators, global.fileSaver, global.core$1, global.ng.forms, global.ng.common, global.popover));
})(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,ɵngcc5,ɵngcc6,exports, core, client, ngxComponents, lodashEs, rxjs, operators, fileSaver, core$1, forms, common, popover) { 
...
var _c0 = ["deviceSoftwareTypeModel"];
var _c1 = ["notFoundTypeAddNewTemplate"];
var _c2 = ["notFoundTypeTemplate"];
function SoftwareTypeComponent_c8y_li_2_Template(rf, ctx) { if (rf & 1) {
    var _r8 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "c8y-li", 6);
    ɵngcc0.ɵɵlistener("click", function SoftwareTypeComponent_c8y_li_2_Template_c8y_li_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r8); var ctx_r7 = ɵngcc0.ɵɵnextContext(); return ctx_r7.clearSoftware(); });
...
function SoftwareTypeComponent_c8y_li_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵelementStart(0, "c8y-li", 6);
    ɵngcc0.ɵɵlistener("click", function SoftwareTypeComponent_c8y_li_3_Template_c8y_li_click_0_listener() { var restoredCtx = ɵngcc0.ɵɵrestoreView(_r11); var software_r9 = restoredCtx.$implicit; var ctx_r10 = ɵngcc0.ɵɵnextContext(); return ctx_r10.selectSoftware(software_r9); });
    ɵngcc0.ɵɵelement(1, "c8y-highlight", 7);
    ɵngcc0.ɵɵpipe(2, "async");
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var software_r9 = ctx.$implicit;
    var ctx_r2 = ɵngcc0.ɵɵnextContext();
...
RepositoryService.ɵfac = function RepositoryService_Factory(t) { return new (t || RepositoryService)(ɵngcc0.ɵɵinject(ɵngcc1.InventoryService), ɵngcc0.ɵɵinject(ɵngcc1.InventoryBinaryService), ɵngcc0.ɵɵinject(ɵngcc1.OperationService), ɵngcc0.ɵɵinject(ɵngcc2.AlertService), ɵngcc0.ɵɵinject(ɵngcc1.EventService), ɵngcc0.ɵɵinject(ɵngcc2.OperationRealtimeService), ɵngcc0.ɵɵinject(ɵngcc1.EventBinaryService), ɵngcc0.ɵɵinject(AdvancedSoftwareService)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RepositoryService, [{
        type: core.Injectable
    }], function () { return [{ type: ɵngcc1.InventoryService }, { type: ɵngcc1.InventoryBinaryService }, { type: ɵngcc1.OperationService }, { type: ɵngcc2.AlertService }, { type: ɵngcc1.EventService }, { type: ɵngcc2.OperationRealtimeService }, { type: ɵngcc1.EventBinaryService }, { type: AdvancedSoftwareService }]; }, null); })();
...
FileDownloadComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: FileDownloadComponent, selectors: [["c8y-file-download"]], inputs: { url: "url" }, decls: 3, vars: 3, consts: [["class", "pointer", "target", "_blank", "rel", "noopener noreferrer", 3, "href", 4, "ngIf"], [4, "ngIf"], ["target", "_blank", "rel", "noopener noreferrer", 1, "pointer", 3, "href"], ["class", "pointer", 3, "click", 4, "ngIf"], [1, "pointer", 3, "click"], ["c8yIcon", "spinner", 1, "icon-spin"]], template: function FileDownloadComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [ɵngcc3.NgIf, ɵngcc2.IconDirective], pipes: [ɵngcc3.AsyncPipe, ɵngcc2.C8yTranslatePipe], encapsulation: 2 });
...
RepositorySelectModalComponent.ɵfac = function RepositorySelectModalComponent_Factory(t) { return new (t || RepositorySelectModalComponent)(ɵngcc0.ɵɵdirectiveInject(RepositoryService), ɵngcc0.ɵɵdirectiveInject(ɵngcc4.TranslateService)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(RepositorySelectModalComponent, [{
    ...
    }], function () { return [{ type: RepositoryService }, { type: ɵngcc4.TranslateService }]; }, null); })();
...
SoftwareTypeComponent.ɵfac = function SoftwareTypeComponent_Factory(t) { return new (t || SoftwareTypeComponent)(ɵngcc0.ɵɵdirectiveInject(RepositoryService), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc4.TranslateService)); };
SoftwareTypeComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: SoftwareTypeComponent, selectors: [["c8y-software-type"]], viewQuery: function SoftwareTypeComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [ɵngcc2.TypeaheadComponent, ɵngcc5.NgControlStatus, ɵngcc5.NgModel, ɵngcc5.RequiredValidator, ɵngcc3.NgStyle, ɵngcc3.NgIf, ɵngcc2.ForOfDirective, ɵngcc2.ListItemComponent, ɵngcc2.HighlightComponent, ɵngcc2.C8yTranslateDirective], pipes: [ɵngcc2.C8yTranslatePipe, ɵngcc3.AsyncPipe], encapsulation: 2 });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(SoftwareTypeComponent, [{
    ...
    }], function () { return [{ type: RepositoryService }, { type: ɵngcc0.ChangeDetectorRef }, { type: ɵngcc4.TranslateService }]; }, { required: [{
            type: core.Input
        }], placeholder: [{
            type: core.Input
        }], emitResultsOnly: [{
...
SharedRepositoryModule.ɵfac = function SharedRepositoryModule_Factory(t) { return new (t || SharedRepositoryModule)(); };
SharedRepositoryModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: SharedRepositoryModule });
SharedRepositoryModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [AdvancedSoftwareService, RepositoryService, ngxComponents.OperationRealtimeService], imports: [[common.CommonModule, ngxComponents.CoreModule, ngxComponents.FormsModule, popover.PopoverModule]] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(SharedRepositoryModule, [{
        type: core.NgModule,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(SharedRepositoryModule, { declarations: [RepositorySelectModalComponent, FileDownloadComponent, SoftwareTypeComponent], imports: [ɵngcc3.CommonModule, ɵngcc2.CoreModule, ɵngcc2.FormsModule, ɵngcc6.PopoverModule], exports: [RepositorySelectModalComponent, FileDownloadComponent, SoftwareTypeComponent] }); })();
