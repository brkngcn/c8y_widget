(function (global, factory) {
    ...
    ***************************************************************************** */
                ...
                return __generator(this, function (_a) {
                    if (this.navs.length === 0) {
                        this.navs.push(new ngxComponents.NavigatorNode({
                            label: ngxComponents.gettext('Device control'),
                            path: 'devicecontrol/single',
                            icon: 'c8y-icon c8y-icon-device-control',
                            parent: ngxComponents.gettext('Overviews'),
                            priority: 1360
                        }));
                    }
    ...
    OperationsModule.decorators = [
        { type: core.NgModule, args: [{
                    imports: [
                        ...
                        operationsList.OperationsListModule
                    ],
                    providers: [
    ...
    exports.NavigationFactory = NavigationFactory;
