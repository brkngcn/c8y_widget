(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@c8y/client'),require('@c8y/ngx-components'),require('@angular/common'),require('@angular/forms'),require('@angular/router'),require('ngx-bootstrap/popover'),require('@ngx-translate/core'),exports, require('@angular/core'), require('@c8y/ngx-components'), require('@c8y/client'), require('lodash-es'), require('@angular/forms'), require('@angular/router'), require('rxjs'), require('rxjs/operators'), require('@c8y/client'), require('ngx-bootstrap/popover'), require('@ngx-translate/core')) :
    typeof define === 'function' && define.amd ? define('@c8y/ngx-components/auth-configuration', ['@angular/core','@c8y/client','@c8y/ngx-components','@angular/common','@angular/forms','@angular/router','ngx-bootstrap/popover','@ngx-translate/core','exports', '@angular/core', '@c8y/ngx-components', '@c8y/client', 'lodash-es', '@angular/forms', '@angular/router', 'rxjs', 'rxjs/operators', '@c8y/client', 'ngx-bootstrap/popover', '@ngx-translate/core'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.c8y.client,global.c8y.ngxComponents,global.ng.common,global.ng.forms,global.ng.router,global.ngxBootstrap.popover,global.ngxTranslate.core,(global.c8y = global.c8y || {}, global.c8y["ngx-components"] = global.c8y["ngx-components"] || {}, global.c8y["ngx-components"]["auth-configuration"] = {}), global.ng.core, global.c8y["ngx-components"], global.client, global.lodashEs, global.ng.forms, global.ng.router, global.rxjs, global.rxjs.operators, global.i1, global.popover, global.core));
})(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,ɵngcc5,ɵngcc6,ɵngcc7,exports, i0, ngxComponents, client, lodashEs, forms, router, rxjs, operators, i1, popover, core) { 
    ...
    var BasicAuthSettingsComponent = /** @class */ (function () {
        ...
        BasicAuthSettingsComponent.prototype.ngDoCheck = function () {
            if (this.preferredLoginOptionType !== this.authConfiguration.preferredLoginOptionType) {
                ...
                if (this.preferredLoginOptionType === client.TenantLoginOptionType.BASIC) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(BasicAuthSettingsComponent, [{
    ...
    BasicAuthSettingsComponent.propDecorators = {
        authConfiguration: [{ type: i0.Input }]
    };

    var SsoConfigurationService = /** @class */ (function () {
        function SsoConfigurationService(loginOptionsService) {
            var _this = this;
            this.loginOptionsService = loginOptionsService;
            this.isSsoConfigurationAvailable$ = rxjs.defer(function () { return _this.loginOptionsService.detail(client.TenantLoginOptionType.OAUTH2); }).pipe(operators.map(function (res) { return true; }), operators.catchError(function (_a) {
                var res = _a.res;
                return (res.status === 403 /* Forbidden */ ? rxjs.of(false) : rxjs.of(true));
            }), 
            // Both guard and tab.factory ask for OAUTH2 - this observable will be send one request in 1 second.
            operators.publishReplay(1, 1000), operators.refCount(), operators.take(1));
        }
        SsoConfigurationService.prototype.showSsoConfiguration$ = function () {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(SsoConfigurationService, [{
        ...
        return SsoConfigurationService;
    }());
    SsoConfigurationService.ɵprov = i0__namespace.ɵɵdefineInjectable({ factory: function SsoConfigurationService_Factory() { return new SsoConfigurationService(i0__namespace.ɵɵinject(i1__namespace.TenantLoginOptionsService)); }, token: SsoConfigurationService, providedIn: "root" });
    SsoConfigurationService.ctorParameters = function () { return [
        { type: client.TenantLoginOptionsService }
    ]; };

    var TabsFactory = /** @class */ (function () {
        function TabsFactory(router, ssoConfigurationService) {
            this.router = router;
        ...
        TabsFactory.prototype.get = function () {
            ...
            var ssoTab$ = this.ssoConfigurationService.showSsoConfiguration$().pipe(operators.switchMap(function (showSsoConfiguration) { return showSsoConfiguration
                ? rxjs.of({
                ...
                : rxjs.EMPTY; }));
            return rxjs.merge([basicSettingsTab$, ssoTab$]).pipe(operators.mergeAll(), operators.toArray());
        };
TabsFactory.ɵfac = function TabsFactory_Factory(t) { return new (t || TabsFactory)(ɵngcc0.ɵɵinject(ɵngcc5.Router), ɵngcc0.ɵɵinject(SsoConfigurationService)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(TabsFactory, [{
        type: i0.Injectable
    }], function () { return [{ type: ɵngcc5.Router }, { type: SsoConfigurationService }]; }, null); })();
        return TabsFactory;
    }());
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AuthConfigurationGuard, [{
    ...
    var TypedOption = /** @class */ (function () {
        function TypedOption(category, key, type, defaultValue, value) {
        ...
        TypedOption.prototype.apply = function (option) {
            this.category = option.category;
            this.key = option.key;
            this.value = option.value;
        };
        TypedOption.prototype.getValue = function () {
            try {
        ...
        TypedOption.prototype.getValueByType = function () {
            switch (this.type) {
                case 'boolean':
        ...
        TypedOption.prototype.parseNumberValue = function (stringValue) {
        ...
        TypedOption.prototype.parseStringValue = function (value) {
    ...
    var AuthConfigurationService = /** @class */ (function () {
        function AuthConfigurationService(tenantLoginOptionsService, tenantOptionsService, systemOptionsService, applicationService, tenantUiService, tenantService) {
            this.tenantLoginOptionsService = tenantLoginOptionsService;
        ...
        AuthConfigurationService.prototype.getTenantOptions$ = function () {
            var _this = this;
            return rxjs.forkJoin(this.tenantOptionsWithDefaultValue.map(function (option) { return rxjs.from(_this.tenantOptionsService.detail(option)).pipe(operators.map(function (res) {
                option.apply(res.data);
                return option;
            }), operators.catchError(function () { return rxjs.of(option); })); })).pipe(operators.map(function (options) { return _this.getOptionsObject(options); }));
        };
        AuthConfigurationService.prototype.getSystemOptions$ = function () {
            var _this = this;
            return rxjs.forkJoin(this.systemOptionsWithDefaultValue.map(function (option) {
                var fixedOption = _this.fixTfaEnforcedSystemOption(option);
                if (fixedOption) {
                    return fixedOption;
                }
                return rxjs.from(_this.systemOptionsService.detail(option)).pipe(operators.map(function (res) {
                    option.apply(res.data);
                    return option;
                }), operators.catchError(function () { return rxjs.of(option); }));
            })).pipe(operators.map(function (options) { return _this.getOptionsObject(options); }));
        };
        /**
         ...
         */
        AuthConfigurationService.prototype.fixTfaEnforcedSystemOption = function (option) {
            if (option.category === 'two-factor-authentication' && option.key === 'enforced') {
                return rxjs.from(this.tenantService.getTfaSettings(this.tenantUiService.currentTenant)).pipe(operators.map(function (tfaSettings) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AuthConfigurationService, [{
        type: i0.Injectable
    }], function () { return [{ type: ɵngcc1.TenantLoginOptionsService }, { type: ɵngcc1.TenantOptionsService }, { type: ɵngcc1.SystemOptionsService }, { type: ɵngcc1.ApplicationService }, { type: ɵngcc2.TenantUiService }, { type: ɵngcc1.TenantService }]; }, null); })();
...
AuthConfigurationComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: AuthConfigurationComponent, selectors: [["c8y-auth-configuration"]], decls: 23, vars: 26, consts: [[3, "placement"], [1, "btn", "btn-link", 3, "title", "click"], ["c8yIcon", "refresh", 3, "ngClass"], ["src", "/users-guide/administration/#authentication"], ["role", "form", "novalidate", "", 1, "card", "card--fullpage"], ["authConfigurationForm", "ngForm"], [1, "card-header", "separator"], [1, "card-title"], ["class", "inner-scroll", 4, "ngIf"], [1, "card-footer", "separator"], [1, "btn", "btn-primary", 3, "title", "disabled", "click"], [1, "inner-scroll"], [3, "authConfiguration"]], template: function AuthConfigurationComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: function () { return [ɵngcc2.TitleComponent, ɵngcc2.ActionBarItemComponent, ɵngcc2.IconDirective, ɵngcc3.NgClass, ɵngcc2.HelpComponent, ɵngcc4.ɵNgNoValidate, ɵngcc4.NgControlStatusGroup, ɵngcc4.NgForm, ɵngcc3.NgIf, LoginSettingsComponent, BasicAuthSettingsComponent, SessionConfigurationComponent, TfaSettingsComponent]; }, pipes: function () { return [ɵngcc2.C8yTranslatePipe, ɵngcc3.AsyncPipe]; }, encapsulation: 2 });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(LoginSettingsComponent, [{
    ...
    var SsoConfigurationGuard = /** @class */ (function () {
        function SsoConfigurationGuard(ssoConfigurationService) {
            this.ssoConfigurationService = ssoConfigurationService;
        }
        SsoConfigurationGuard.prototype.canActivate = function () {
            return this.ssoConfigurationService.showSsoConfiguration$();
        };
SsoConfigurationGuard.ɵfac = function SsoConfigurationGuard_Factory(t) { return new (t || SsoConfigurationGuard)(ɵngcc0.ɵɵinject(SsoConfigurationService)); };
SsoConfigurationGuard.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: SsoConfigurationGuard, factory: function (t) { return SsoConfigurationGuard.ɵfac(t); } });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(SsoConfigurationGuard, [{
        type: i0.Injectable
    }], function () { return [{ type: SsoConfigurationService }]; }, null); })();
        return SsoConfigurationGuard;
    }());
    SsoConfigurationGuard.ctorParameters = function () { return [
        { type: SsoConfigurationService }
    ]; };
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(AuthConfigurationModule, { declarations: [SessionConfigurationComponent, LoginSettingsComponent, BasicAuthSettingsComponent, AuthConfigurationComponent, TfaSettingsComponent], imports: [ɵngcc2.CoreModule, ɵngcc6.PopoverModule] }); })();
    ...
    exports["ɵh"] = SsoConfigurationService;
    exports["ɵi"] = SsoConfigurationGuard;
    exports["ɵj"] = NavigationFactory;
