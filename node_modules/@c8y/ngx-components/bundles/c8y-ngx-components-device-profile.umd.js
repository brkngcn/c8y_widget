(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@c8y/ngx-components'), require('@c8y/client'), require('lodash-es'), require('rxjs'), require('rxjs/operators'), require('@c8y/ngx-components/repository/shared'), require('@angular/router'), require('ngx-bootstrap/dropdown'), require('ngx-bootstrap/popover'), require('ngx-bootstrap/tooltip'), require('ngx-bootstrap/buttons'), require('@angular/forms'), require('ngx-bootstrap/modal'), require('@ngx-translate/core'), require('@c8y/ngx-components/operations/operation-details')) :
    typeof define === 'function' && define.amd ? define('@c8y/ngx-components/device-profile', ['exports', '@angular/core', '@c8y/ngx-components', '@c8y/client', 'lodash-es', 'rxjs', 'rxjs/operators', '@c8y/ngx-components/repository/shared', '@angular/router', 'ngx-bootstrap/dropdown', 'ngx-bootstrap/popover', 'ngx-bootstrap/tooltip', 'ngx-bootstrap/buttons', '@angular/forms', 'ngx-bootstrap/modal', '@ngx-translate/core', '@c8y/ngx-components/operations/operation-details'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.c8y = global.c8y || {}, global.c8y["ngx-components"] = global.c8y["ngx-components"] || {}, global.c8y["ngx-components"]["device-profile"] = {}), global.ng.core, global.c8y["ngx-components"], global.client, global.lodashEs, global.rxjs, global.rxjs.operators, global.c8y["ngx-components"].repository.shared, global.ng.router, global.dropdown, global.popover, global.tooltip, global.buttons, global.ng.forms, global.modal, global.core$1, global.c8y["ngx-components"].operations["operation-details"]));
})(this, (function (exports, core, ngxComponents, client, lodashEs, rxjs, operators, shared, router, dropdown, popover, tooltip, buttons, forms, modal, core$1, operationDetails) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var SelectConfigurationModalComponent = /** @class */ (function () {
        ...
        SelectConfigurationModalComponent.prototype.getItems = function () {
            return this.repositoryService.listRepositoryEntries(shared.RepositoryType.CONFIGURATION, {
    ...
    var DeviceProfileComponent = /** @class */ (function () {
        function DeviceProfileComponent(route, alertService, inventoryService, bsModal, repositoryService) {
            this.route = route;
            this.alertService = alertService;
            this.inventoryService = inventoryService;
        ...
        DeviceProfileComponent.prototype.addFirmware = function () {
            var _this = this;
            var initialState = {
                deviceTypeQuery: this.getDeviceTypeQuery(shared.RepositoryType.FIRMWARE),
                repositoryType: shared.RepositoryType.FIRMWARE,
                repositoryEntriesWithVersionsFn$: function (modalDialog) { return _this.getRepositoryEntriesWithVersions$(modalDialog.content.searchTerm, shared.RepositoryType.FIRMWARE); },
                icon: 'c8y-firmware',
                title: ngxComponents.gettext('Select firmware'),
                mode: ngxComponents.ModalSelectionMode.SINGLE
            };
            var modal = this.bsModal.show(shared.RepositorySelectModalComponent, {
        ...
        DeviceProfileComponent.prototype.getRepositoryEntriesWithVersions$ = function (searchTerm$, repoType) {
            ...
            return searchTerm$.pipe(operators.distinctUntilChanged(), operators.switchMap(function (searchTerm) { return _this.repositoryService.listRepositoryEntries(repoType, {
                query: _this.getDeviceTypeQuery(repoType),
        ...
        DeviceProfileComponent.prototype.addConfiguration = function () {
            ...
            modal.content.deviceTypeQuery = this.getDeviceTypeQuery(shared.RepositoryType.CONFIGURATION);
        ...
        DeviceProfileComponent.prototype.addSoftware = function () {
            var _this = this;
            var initialState = {
                deviceTypeQuery: this.getDeviceTypeQuery(shared.RepositoryType.SOFTWARE),
                repositoryType: shared.RepositoryType.SOFTWARE,
                repositoryEntriesWithVersionsFn$: function (modalDialog) { return _this.getRepositoryEntriesWithVersions$(modalDialog.content.searchTerm, shared.RepositoryType.SOFTWARE); },
        ...
        DeviceProfileComponent.prototype.getDeviceTypeQuery = function (repositoryType) {
            if (lodashEs.has(this.deviceProfile, 'c8y_Filter.type') &&
                ...
                if (repositoryType === shared.RepositoryType.CONFIGURATION) {
