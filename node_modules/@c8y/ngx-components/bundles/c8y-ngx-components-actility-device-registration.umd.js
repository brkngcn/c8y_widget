(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@c8y/client'),require('@ngx-translate/core'),require('@c8y/ngx-components'),require('ngx-bootstrap/modal'),require('@angular/common'),require('@angular/cdk/stepper'),require('@ngx-formly/core'),exports, require('@angular/core'), require('ngx-bootstrap/modal'), require('@c8y/ngx-components'), require('@angular/forms'), require('rxjs'), require('lodash-es'), require('@ngx-translate/core'), require('@c8y/client'), require('@c8y/client'), require('@c8y/client'), require('@c8y/client'), require('rxjs/operators'), require('@c8y/ngx-components/register-device')) :
    typeof define === 'function' && define.amd ? define('@c8y/ngx-components/actility-device-registration', ['@angular/core','@c8y/client','@ngx-translate/core','@c8y/ngx-components','ngx-bootstrap/modal','@angular/common','@angular/cdk/stepper','@ngx-formly/core','exports', '@angular/core', 'ngx-bootstrap/modal', '@c8y/ngx-components', '@angular/forms', 'rxjs', 'lodash-es', '@ngx-translate/core', '@c8y/client', '@c8y/client', '@c8y/client', '@c8y/client', 'rxjs/operators', '@c8y/ngx-components/register-device'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.c8y.client,global.ngxTranslate.core,global.c8y.ngxComponents,global.ngxBootstrap.modal,global.ng.common,global.ng.cdk.stepper,global.ngxFormly.core,(global.c8y = global.c8y || {}, global.c8y["ngx-components"] = global.c8y["ngx-components"] || {}, global.c8y["ngx-components"]["actility-device-registration"] = {}), global.ng.core, global.modal, global.c8y["ngx-components"], global.ng.forms, global.rxjs, global.lodashEs, global.i3, global.client, global.i1, global.i2, global.i4, global.rxjs.operators, global.c8y["ngx-components"]["register-device"]));
})(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,ɵngcc5,ɵngcc6,ɵngcc7,exports, i0, modal, i5, forms, rxjs, lodashEs, i3, client, i1, i2, i4, operators, registerDevice) { 
...
var _c0 = function () { return { cancel: true, next: true }; };
var _c1 = function () { return { custom: true }; };
function ActilityDeviceRegistrationComponent_ng_template_7_c8y_stepper_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onNext", function ActilityDeviceRegistrationComponent_ng_template_7_c8y_stepper_0_Template_c8y_stepper_buttons_onNext_7_listener($event) { ɵngcc0.ɵɵrestoreView(_r9); var ctx_r8 = ɵngcc0.ɵɵnextContext(2); return ctx_r8.register($event); })("onCancel", function ActilityDeviceRegistrationComponent_ng_template_7_c8y_stepper_0_Template_c8y_stepper_buttons_onCancel_7_listener() { ɵngcc0.ɵɵrestoreView(_r9); var ctx_r10 = ɵngcc0.ɵɵnextContext(2); return ctx_r10.bsModalRef.hide(); });
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
    ...
    ɵngcc0.ɵɵlistener("onCustom", function ActilityDeviceRegistrationComponent_ng_template_7_c8y_stepper_0_Template_c8y_stepper_buttons_onCustom_12_listener() { ɵngcc0.ɵɵrestoreView(_r9); var ctx_r11 = ɵngcc0.ɵɵnextContext(2); return ctx_r11.bsModalRef.hide(); });
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
var _c2 = function (a0, a1) { return { "text-center": a0, "alert alert-danger": a1 }; };
...
function ActilityDeviceRegistrationComponent_ng_template_9_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ActilityDeviceRegistrationComponent_ng_template_9_Template_button_click_5_listener() { ɵngcc0.ɵɵrestoreView(_r16); var ctx_r15 = ɵngcc0.ɵɵnextContext(); return ctx_r15.bsModalRef.hide(); });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ActilityDeviceRegistrationModule, { declarations: [ActilityDeviceRegistrationButtonComponent, ActilityDeviceRegistrationComponent], imports: [ɵngcc3.CoreModule, ɵngcc3.CommonModule] }); })();
