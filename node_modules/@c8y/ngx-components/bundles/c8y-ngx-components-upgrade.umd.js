    ...
    ***************************************************************************** */
    ...
    var BridgeService = /** @class */ (function () {
        ...
        BridgeService.prototype.addRoute = function (cfg) {
            var _this = this;
            this.routerService.addRoute(Object.assign({ label: cfg.label || cfg.name, path: cfg.path, icon: cfg.icon, context: ngxComponents.ViewContext[cfg.contextKey], priority: cfg.priority, component: ngxComponents.EmptyComponent, data: {
                    showIf: cfg.showIf
                        ? function (ngxRoute) {
                            var _a;
    ...
    var Ng1SmartRulesService = /** @class */ (function () {
        function Ng1SmartRulesService() {
        }
        return Ng1SmartRulesService;
    }());
    function SmartRulesServiceFactory(injector) {
        return injector.get('smartRulesSvc');
    }
    var smartRulesServiceProvider = {
    ...
    var emptyStateComponent = _static.downgradeComponent({ component: ngxComponents.EmptyStateComponent });
    var datapointSelectionListComponent = _static.downgradeComponent({
        component: datapointSelector.DatapointSelectionListComponent
    });
    ...
    var gainsightService = _static.downgradeInjectable(ngxComponents.GainsightService);
    var filesService = _static.downgradeInjectable(ngxComponents.FilesService);
    ...
    DashboardUpgradeModule.decorators = [
        { type: core.NgModule, args: [{
                    ...
                    imports: [common.CommonModule, ngxComponents.C8yTranslateModule, assetsNavigator.AssetSelectorModule],
                    providers: [
                        {
                            ...
                            deps: [
                                ...
                                core.NgZone,
                                router.Router,
                                [new core.Optional(), contextDashboard.ContextDashboardService]
                            ]
                        },
    ...
    exports.Ng1SmartRulesService = Ng1SmartRulesService;
    exports.Ng1TabsFactoryService = Ng1TabsFactoryService;
    exports.SmartRulesServiceFactory = SmartRulesServiceFactory;
    ...
    exports.smartRulesServiceProvider = smartRulesServiceProvider;
