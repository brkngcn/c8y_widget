(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@c8y/ngx-components'), require('@c8y/ngx-components/repository/shared'), require('@c8y/ngx-components/operations/bulk-operation-stepper'), require('@c8y/ngx-components/operations/bulk-operations-service'), require('@c8y/ngx-components/operations/stepper-frames'), require('@ngx-translate/core'), require('lodash-es'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('@c8y/ngx-components/operations/stepper-bulk-type-configuration', ['exports', '@angular/core', '@angular/forms', '@c8y/ngx-components', '@c8y/ngx-components/repository/shared', '@c8y/ngx-components/operations/bulk-operation-stepper', '@c8y/ngx-components/operations/bulk-operations-service', '@c8y/ngx-components/operations/stepper-frames', '@ngx-translate/core', 'lodash-es', 'rxjs', 'rxjs/operators'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.c8y = global.c8y || {}, global.c8y["ngx-components"] = global.c8y["ngx-components"] || {}, global.c8y["ngx-components"].operations = global.c8y["ngx-components"].operations || {}, global.c8y["ngx-components"].operations["stepper-bulk-type-configuration"] = {}), global.ng.core, global.ng.forms, global.c8y["ngx-components"], global.c8y["ngx-components"].repository.shared, global.c8y["ngx-components"].operations["bulk-operation-stepper"], global.c8y["ngx-components"].operations["bulk-operations-service"], global.c8y["ngx-components"].operations["stepper-frames"], global.core$1, global.lodashEs, global.rxjs, global.rxjs.operators));
})(this, (function (exports, core, forms, ngxComponents, shared, bulkOperationStepper, bulkOperationsService, stepperFrames, core$1, lodashEs, rxjs, operators) { 'use strict';
    ...
    var StepperBulkTypeConfigurationComponent = /** @class */ (function (_super) {
        ...
        StepperBulkTypeConfigurationComponent.prototype.loadConfigurationTypes = function () {
            ...
            this.configTypeSubscription = this.configType$
                ...
                return rxjs.from(_this.repositoryService.listRepositoryEntries(shared.RepositoryType.CONFIGURATION, { query: query }));
            }))
        ...
        StepperBulkTypeConfigurationComponent.prototype.getConfiguration = function (name, configurationType) {
            ...
            return this.repositoryService.listRepositoryEntries(shared.RepositoryType.CONFIGURATION, { query: query });
        };
