(function (global, factory) {
    ...
    var MESSAGES = {
        ...
        '^URL where the OAuth token is requested from (required if OAuth method is chosen)$': {
            gettext: ngxComponents.gettext('URL where the OAuth token is requested from (required if OAuth method is selected)')
        },
                        ...
                        ngxComponents.ProviderConfigurationModule.config([
                            {
                                ...
                                layout: {
                                    ...
                                    description: ngxComponents.gettext('Enter your credentials from your SMS provider. This enables platform features that utilize SMS services (for example, two-factor authentication and user notifications).'),
