(function (global, factory) {
    ...
    var AppLogsService = /** @class */ (function () {
        function AppLogsService(application) {
        ...
        AppLogsService.prototype.getLogs$ = function (appId, instanceName, params) {
            ...
            return rxjs.from(this.application.getInstanceLog(appId, instanceName, modifiedParams)).pipe(operators.map(function (res) { return res.data; }));
        };
