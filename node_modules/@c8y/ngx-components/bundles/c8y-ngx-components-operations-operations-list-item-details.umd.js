(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('@c8y/ngx-components'),require('@c8y/ngx-components/operations/bulk-single-operations-list'),require('ngx-bootstrap/tooltip'),require('@c8y/ngx-components/operations/status-filter'),exports, require('@angular/core'), require('ngx-bootstrap/tooltip'), require('@c8y/ngx-components'), require('@c8y/ngx-components/operations/bulk-single-operations-list'), require('@c8y/ngx-components/operations/status-filter')) :
    typeof define === 'function' && define.amd ? define('@c8y/ngx-components/operations/operations-list-item-details', ['@angular/core','@angular/common','@c8y/ngx-components','@c8y/ngx-components/operations/bulk-single-operations-list','ngx-bootstrap/tooltip','@c8y/ngx-components/operations/status-filter','exports', '@angular/core', 'ngx-bootstrap/tooltip', '@c8y/ngx-components', '@c8y/ngx-components/operations/bulk-single-operations-list', '@c8y/ngx-components/operations/status-filter'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.common,global.c8y.ngxComponents,global.c8y.ngxComponents.operations.bulkSingleOperationsList,global.ngxBootstrap.tooltip,global.c8y.ngxComponents.operations.statusFilter,(global.c8y = global.c8y || {}, global.c8y["ngx-components"] = global.c8y["ngx-components"] || {}, global.c8y["ngx-components"].operations = global.c8y["ngx-components"].operations || {}, global.c8y["ngx-components"].operations["operations-list-item-details"] = {}), global.ng.core, global.tooltip, global.c8y["ngx-components"], global.c8y["ngx-components"].operations["bulk-single-operations-list"], global.c8y["ngx-components"].operations["status-filter"]));
})(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,ɵngcc5,exports, core, tooltip, ngxComponents, bulkSingleOperationsList, statusFilter) { 
var _c0 = ["details"];
var _c1 = ["audit"];
...
function OperationDetailsTabsComponent_li_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function OperationDetailsTabsComponent_li_3_Template_button_click_1_listener() { var restoredCtx = ɵngcc0.ɵɵrestoreView(_r10); var tab_r8 = restoredCtx.$implicit; var ctx_r9 = ɵngcc0.ɵɵnextContext(); return ctx_r9.template = tab_r8.template; });
...
function OperationDetailsTabsComponent_ng_template_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("showFailedOperation", function OperationDetailsTabsComponent_ng_template_5_Template_c8y_operation_details_showFailedOperation_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r12); var ctx_r11 = ɵngcc0.ɵɵnextContext(); return ctx_r11.showFailedOperation.emit($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function OperationDetailsTabsComponent_c8y_single_operations_list_9_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onRetryFailedOperations", function OperationDetailsTabsComponent_c8y_single_operations_list_9_Template_c8y_single_operations_list_onRetryFailedOperations_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r14); var ctx_r13 = ɵngcc0.ɵɵnextContext(); return ctx_r13.onRetryFailedOperations.emit($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function OperationDetailsComponent_li_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function OperationDetailsComponent_li_6_Template_a_click_4_listener() { ɵngcc0.ɵɵrestoreView(_r8); var ctx_r7 = ɵngcc0.ɵɵnextContext(); return ctx_r7.openBulkOperationDetails(ctx_r7.operation.bulkOperationId); });
    ɵngcc0.ɵɵtext(5);
    ɵngcc0.ɵɵpipe(6, "translate");
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
...
var _c3 = function (a0) { return { bulkOperationsCountSuccessful: a0 }; };
...
var _c4 = function (a0) { return { bulkOperationsCountFailed: a0 }; };
...
var _c5 = function (a0) { return { bulkOperationsCountExecuting: a0 }; };
...
var _c6 = function (a0) { return { bulkOperationsCountPending: a0 }; };
...
function OperationDetailsComponent_li_17_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function OperationDetailsComponent_li_17_Template_button_click_4_listener() { ɵngcc0.ɵɵrestoreView(_r19); var ctx_r18 = ɵngcc0.ɵɵnextContext(); return ctx_r18.scrollToRetriedFromOperation(ctx_r18.operation.failedParentId); });
    ɵngcc0.ɵɵpipe(5, "translate");
    ɵngcc0.ɵɵtext(6);
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementEnd();
...
'use strict';
    ...
    var OperationDetailsTabsComponent = /** @class */ (function () {
        function OperationDetailsTabsComponent() {
            this.readOnly = false;
            this.onRetryFailedOperations = new core.EventEmitter();
            this.showFailedOperation = new core.EventEmitter();
            this.tabs = [];
        }
        OperationDetailsTabsComponent.prototype.ngOnInit = function () {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(OperationDetailsTabsComponent, [{
        ...
        return OperationDetailsTabsComponent;
    }());
    OperationDetailsTabsComponent.propDecorators = {
        operation: [{ type: core.Input }],
        readOnly: [{ type: core.Input }],
        bulkOperationModalDetailsService: [{ type: core.Input }],
    ...
    var OperationDetailsComponent = /** @class */ (function () {
        ...
        OperationDetailsComponent.prototype.scrollToRetriedFromOperation = function (failedOperationId) {
            this.showFailedOperation.emit(failedOperationId);
        };
        OperationDetailsComponent.prototype.openBulkOperationDetails = function (bulkOperationId) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(OperationDetailsComponent, [{
     ...
     */
    var OperationsListItemDetailsModule = /** @class */ (function () {
        function OperationsListItemDetailsModule() {
        }
...
OperationsListItemDetailsModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[ngxComponents.CoreModule, tooltip.TooltipModule, statusFilter.StatusFilterModule, bulkSingleOperationsList.BulkSingleOperationsListModule]] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(OperationsListItemDetailsModule, [{
        type: core.NgModule,
        args: [{
                imports: [ngxComponents.CoreModule, tooltip.TooltipModule, statusFilter.StatusFilterModule, bulkSingleOperationsList.BulkSingleOperationsListModule],
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(OperationsListItemDetailsModule, { declarations: [OperationDetailsComponent, OperationDetailsTabsComponent], imports: [ɵngcc2.CoreModule, ɵngcc4.TooltipModule, ɵngcc5.StatusFilterModule, ɵngcc3.BulkSingleOperationsListModule], exports: [OperationDetailsComponent, OperationDetailsTabsComponent] }); })();
        return OperationsListItemDetailsModule;
    }());
    ...
    exports.OperationDetailsTabsComponent = OperationDetailsTabsComponent;
    exports.OperationsListItemDetailsModule = OperationsListItemDetailsModule;

    Object.defineProperty(exports, '__esModule', { value: true });

}));

//# sourceMappingURL=c8y-ngx-components-operations-operations-list-item-details.umd.js.map