...
export declare class InventorySearchService {
    ...
    FRAGMENTS_FOR_NO_DEVICE: string[];
    TYPES_FOR_NO_DEVICE: string[];
    DEVICE_FRAGMENT_TYPE: string;
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<InventorySearchService, never>;
}
