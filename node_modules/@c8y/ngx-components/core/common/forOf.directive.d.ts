import { ChangeDetectorRef, ComponentFactoryResolver, TemplateRef, ViewContainerRef } from '@angular/core';
...
export declare class ForOfDirective {
    ...
    private c8yForCount;
    private count;
    constructor(tpl: TemplateRef<any>, vcr: ViewContainerRef, componentFactoryResolver: ComponentFactoryResolver, cdRef: ChangeDetectorRef);
    ngOnInit(): void;
    private ngOnChanges;
    private ngOnDestroy;
