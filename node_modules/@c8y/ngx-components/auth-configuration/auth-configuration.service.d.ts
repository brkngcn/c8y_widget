import { ApplicationService, IResult, ITenantLoginOption, ITenantOption, SystemOptionsService, TenantLoginOptionsService, TenantOptionsService, TenantService } from '@c8y/client';
...
export declare class AuthConfigurationService {
    ...
    constructor(tenantLoginOptionsService: TenantLoginOptionsService, tenantOptionsService: TenantOptionsService, systemOptionsService: SystemOptionsService, applicationService: ApplicationService, tenantUiService: TenantUiService, tenantService: TenantService);
