...
import { ActionBarService, AlertService, BreadcrumbItem, DashboardChildChange, DashboardSettings, DynamicComponentDefinition, GainsightService, ModalService, Widget, WidgetChange } from '@c8y/ngx-components';
...
export declare class ContextDashboardComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ContextDashboardComponent, "c8y-context-dashboard", never, { "childrenClasses": "childrenClasses"; "setTitle": "setTitle"; "disabled": "disabled"; "defaultWidgets": "defaultWidgets"; "canCopy": "canCopy"; "canDelete": "canDelete"; "isLoading": "isLoading"; "context": "context"; "breadcrumbSettings": "breadcrumbSettings"; "name": "name"; }, {}, never, never>;
}
