...
import { InjectionToken, Injectable, Component, Inject, ViewChild, ViewContainerRef, EventEmitter, Input, Output, Optional, Renderer2, HostBinding, TemplateRef, NgModule } from '@angular/core';
import { __awaiter, __rest } from 'tslib';
import * as i2 from '@c8y/ngx-components';
import { gettext, Status, NavigatorNode, getActivatedRoute, ViewContext, TabsService, ModalService, NavigatorService, Permissions, AlertService, ICON_LIST, ContextRouteService, AppStateService, DynamicComponentService, DashboardChildChange, GainsightService, ActionBarService, HOOK_ROUTE, HOOK_TABS, HOOK_ACTION_BAR, CoreModule, DocsService, DocsModule, QuickLinkModule, HOOK_NAVIGATOR_NODES, HOOK_COMPONENTS, HOOK_ONCE_ROUTE, FilterInputComponent } from '@c8y/ngx-components';
import * as i3$1 from 'ngx-bootstrap/modal';
import { BsModalRef, BsModalService } from 'ngx-bootstrap/modal';
import * as i4 from '@angular/router';
import { Router, ActivatedRoute, RouterModule } from '@angular/router';
import { InventoryService, QueriesUtil, TenantService, ApplicationService } from '@c8y/client';
import * as i3 from '@ngx-translate/core';
import { TranslateService } from '@ngx-translate/core';
import { assign, pick, some, keys, keyBy, has, reduce, cloneDeep, forEach, get, clone, sortBy, omit, escapeRegExp, findIndex, values, kebabCase, every } from 'lodash-es';
import { of, from, Subject, iif, timer, BehaviorSubject, combineLatest } from 'rxjs';
import { tap, map, catchError, throwIfEmpty, filter, toArray, mergeAll, mergeMap, switchMap, debounceTime, distinctUntilChanged, shareReplay } from 'rxjs/operators';
...
AddDashboardFactory.ɵprov = i0.ɵɵdefineInjectable({ factory: function AddDashboardFactory_Factory() { return new AddDashboardFactory(i0.ɵɵinject(i2.Permissions), i0.ɵɵinject(ContextDashboardService), i0.ɵɵinject(i3$1.BsModalService), i0.ɵɵinject(i2.ContextRouteService)); }, token: AddDashboardFactory, providedIn: "root" });
...
WidgetService.ɵprov = i0.ɵɵdefineInjectable({ factory: function WidgetService_Factory() { return new WidgetService(i0.ɵɵinject(i2.DynamicComponentService), i0.ɵɵinject(i3.TranslateService), i0.ɵɵinject(CONTEXT_DASHBOARD_CONFIG, 8)); }, token: WidgetService, providedIn: "root" });
...
DashboardActionBarFactory.ɵprov = i0.ɵɵdefineInjectable({ factory: function DashboardActionBarFactory_Factory() { return new DashboardActionBarFactory(i0.ɵɵinject(ContextDashboardService)); }, token: DashboardActionBarFactory, providedIn: "root" });
