...
export declare class SoftwareTypeComponent implements OnInit, ControlValueAccessor, Validator {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<SoftwareTypeComponent, "c8y-software-type", never, { "required": "required"; "placeholder": "placeholder"; "emitResultsOnly": "emitResultsOnly"; "showBtnInNotFoundMessage": "showBtnInNotFoundMessage"; "allowFreeEntries": "allowFreeEntries"; "showClearSelectionOption": "showClearSelectionOption"; "clearSelectionOptionLabel": "clearSelectionOptionLabel"; "softwareTypeMO": "softwareTypeMO"; "disabled": "disabled"; "style": "style"; }, { "onSelectSoftware": "onSelectSoftware"; }, never, never>;
}
