import { StatusOption } from './status-options.model';
/**
...
export declare class StatusOptionsService {
    get options(): StatusOption[];
    private _options;
    constructor(options: Array<StatusOption | StatusOption[]>);
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<StatusOptionsService, [{ optional: true; }]>;
}

//# sourceMappingURL=status-options.service.d.ts.map