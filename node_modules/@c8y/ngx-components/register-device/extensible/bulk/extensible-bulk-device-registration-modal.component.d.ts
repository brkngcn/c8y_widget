...
export declare class ExtensibleBulkDeviceRegistrationModalComponent implements OnInit {
    ...
    complete(): void;
    cancel(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ExtensibleBulkDeviceRegistrationModalComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ExtensibleBulkDeviceRegistrationModalComponent, "extensible-device-registration-modal-component", never, {}, {}, never, never>;
}
